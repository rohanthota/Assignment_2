...
\begin{enumerate}
    ...
    \end{multline*}
    \item \mbox{The probability that the marble picked was not }
    \begin{align*}\mbox{green can be written as} \pr{X \ne 2}.
    \\\mbox{We know that} \pr{X \ne 2} + \pr{X = 2} = 1. 
    \end{align*}
...
\end{enumerate}
\includegraphics[width=105mm]{Assignment 2 graph}
